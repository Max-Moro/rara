...
Перед установкой скачайте заранее на свой компьютер [торрент](https://rutracker.org/todo) и клонируйте данный Git-репозиторий.  
...
5. Скачать [торрент](https://rutracker.org/todo). Скопировать папку `roms` в корень папки `retroarch` на карте памяти вашего устройства.
...
6. Скачать [торрент](https://rutracker.org/todo). Скопировать папку `roms` в корень папки `retroarch` на телефоне.
...
4. В самом RetroArch скачать следующие ядра (**Главное меню** -> **Онлайн обновления** -> **Скачать ядра**):
    ...
    - DOS (DOSBox-Pure)
    - ScummVM
5. Скачать [торрент](https://rutracker.org/todo). Скопировать папку `roms` в корень установленной программы RetroArch.
